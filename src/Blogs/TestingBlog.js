...
function TestingBlog() {
  return (
    <div className="mt-20 flex justify-center flex-col" id="blog">
      <NavBarBlog />
      <div className="w-full sm:w-3/4 mx-auto">
        <img
          src="https://ds6br8f5qp1u2.cloudfront.net/blog/wp-content/uploads/2021/03/7-Common-Types-of-Software-Testing@1x.png?x40138"
        ...
        <div className="p-10 sm:px-20 text-gray-700 text-lg">
          <p className="mt-4">
            ...
            try to find bugs. As software became more complex, however, it
            became clear that more rigorous and systematic testing was needed.
          </p>
          ...
          <p className="mt-4">
            ...
            and regression testing. These methodologies provided a more
            systematic approach to testing, and the new tools helped to automate
            many of the repetitive tasks involved.
          </p>

          <p className="mt-4">
            In the 1990s, software testing became increasingly integrated with
            the software development lifecycle (SDLC). This led to the emergence
            of new concepts such as continuous testing and quality assurance
            (QA). Continuous testing involves testing software throughout the
            development process, rather than just at the end. QA is a broader
            discipline that encompasses all aspects of software quality,
            including testing, requirements management, and risk management.
          </p>
          ...
          <p className="mt-4">
            ...
            testing, with new tools and techniques being developed to help
            testers automate tasks such as test case generation and defect
            detection.
          </p>
          ...
          <p className="mt-4">
            I am excited about the future of software testing, and I believe
            that it will continue to evolve and innovate as software becomes
